...
const projects = [
    ...
    },
    {
    ...
    }, 
     {
        ...
        description: "Software integration and hardware assembly for spherical robot under European Space Agency's Moon exploration challenge.",
        researchPaperUrl: "https://opus.bibliothek.uni-wuerzburg.de/frontdoor/index/index/docId/22791",
        stack: [
            {
                name: "Python",
                icon: (
